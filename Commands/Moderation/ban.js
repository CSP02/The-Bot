...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName("ban")
        .setDescription("Bans the mentioned user with a reason.")
        .addUserOption(option => option.setName("user").setDescription("User to ban.").setRequired(true))
        .addStringOption(option => option.setName("reason").setDescription("Reason to ban this user.")),
    ...
    async execute(Discord, client, interaction) {
        try {
            ...
            interaction.guild.members.cache.get(user.id).ban({ reason: reason }); //? Bans the member
            ...
            const infr = { //? Create the infr object to push it into the infractions array
                ...
                reason: reason,
                timestamp: Date.now(),
                infrType: InfractionTypes.Ban //? Set infraction type to "Ban"(4)
            }
            ...
            if (infractionInDB === null) {
                ...
                const embed = new EmbedBuilder()
                    ...
                    .addFields([
                        ...
                        { name: "Infraction type", value: "ban" },
                ...
                await interaction.guild.members.cache.get(user.id).send({ content: `You are baned in ${interaction.guild.name}:`, embeds: [embed] })
