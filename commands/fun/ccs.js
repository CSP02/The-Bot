...
module.exports = {
	name: 'checkcoins',
	description: 'checks info about your coins and number of gifts you sent',
	permissions: [PermissionsBitField.Flags.ViewChannel],
	aliases: ['cc', 'chrishmascoins', 'coins'],
	syntax: '!coins',
	async execute(client, message, args, Discord) {
		...
		try {
			...
			if (!isAvailable) {
				return message.channel.send('You have no coins yet. You can start by sending a gift to someone or by using the `!collect` command.')
			}
